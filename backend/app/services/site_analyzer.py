...
Найди ВСЕ категории товаров и их URL на сайте. Ищи в навигации, меню, каталоге.
...
[
  {
    ...
    "url": "/catalog/divany/",
    "subcategories": [
      {"name": "Угловые диваны", "url": "/catalog/divany/uglovye/"},
      {"name": "Прямые диваны", "url": "/catalog/divany/pryamye/"}
    ]
  }
]

Правила:
- Только категории ТОВАРОВ (не страницы "О компании", "Доставка", и т.д.)
- URL может быть относительным или абсолютным
- subcategories может быть пустым массивом
